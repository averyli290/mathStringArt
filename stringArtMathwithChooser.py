...
class painting(Canvas):
    ...
    #       self.drawSquare((0, 0), (600, 600), (300, 300), 34, None, "out", False)
    #                                                              ^       ^
    ...
    def pic1(self, window_width, window_length, color1, color2):
        tl = [20, 20]
        ...
        for i in range(15):
            ...
            self.drawSquare((tl[0], tl[1]), (br[0], br[1]), c, 34, None, "out", rotate)

    #pic1(600, 600, "#211F2E", "#701A19")
    #     ^    ^ 
    #     |    |
    ...
    def pic3(self, window_width, window_length):
        ...
        for i in range(9):
            if i % 2 == 0:
                self.drawCurve((tl[0], tl[1]), (br[0], br[1]), (tl[0], br[1]), 50, "black", colors[i%len(colors)] ,"out", 1)
                self.drawCurve((tl[0], tl[1]), (br[0], br[1]), (br[0], tl[1]), 50, "black", colors[i%len(colors)], "out", 1)
            else:
                self.drawCurve((tl[0], br[1]), (br[0], tl[1]), (tl[0], tl[1]), 50, "black", colors[i%len(colors)] ,"out", 1)
                self.drawCurve((tl[0], br[1]), (br[0], tl[1]), (br[0], br[1]), 50, "black", colors[i%len(colors)], "out", 1)
            tl = (math.ceil((center[0]+tl[0])/2), math.ceil((center[1]+tl[1])/2))
            br = (math.ceil((center[0]+br[0])/2), math.ceil((center[1]+br[1])/2))

    #pic3(600, 600)

p = painting(r1, "pic1", 600, 600)
